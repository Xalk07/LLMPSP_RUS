...
Форк движка LLM для Sony PSP с поддержкой русского языка и клавиатуры, запускающая локально языковую модель с 90 миллионов параметров.

2 раскладки - Английская и Русская. Добавлено переключение нажатием L+R. 
Вы можете изменять параметры генерации в файле llmpsp_config.cfg для поиска приемлемого ответа.
Либо взять другую модель и сконвертировать её с помощью Python скрипта от оригинального автора.

![LLMPSP screenshot](demo/2026-09-14_15-24.png)
Создан с помощью ChatGPT и Grok, с проверкой человека.
